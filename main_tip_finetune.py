...
import os
os.environ['TORCH_HOME']='/zengyq/home_old'
import sys
import torch
import random
import warnings
...
if __name__ == '__main__':
    ...
    parser.add_argument('--port', default='1223', type=str)
    parser.add_argument('--seed', default=814, type=int)
    ...
    parser.add_argument('--prefix_length', default=16, type=int,
                        help="number of [PREFIX] tokens at the beginning of sentences")
    parser.add_argument('--conjun_length', default=0, type=int,
    ...
    parser.add_argument('--zs_type', type=str, default='[]', choices=['default', 'rare_first', 'non_rare_first', 'unseen_verb', 'unseen_object', 'uc0', 'uc1', 'uc2', 'uc3', 'uc4'])
